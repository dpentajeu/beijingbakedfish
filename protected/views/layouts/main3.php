			...
			<div class="box">
				...
				<?php $this->widget('zii.widgets.CMenu', array(
					...
					'items' => array(
						...
						array('label'=>'Refer a member', 'url'=>array('member/refermember'), 'linkOptions'=>array('class'=>'icon report')),
						...
						array('label'=>'Transfer point', 'url'=>array('member/transfercp'), 'linkOptions'=>array('class'=>'icon report')),
