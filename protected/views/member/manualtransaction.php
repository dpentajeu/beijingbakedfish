...
<div class="full_w">
        ...
        <div class="form">
            <div class="n_warning"><p>Note: Amount refers to total cash point / redemption point which will be deducted.</p></div>
		...
		<div class="n_ok"><p><?= $notice; ?></p></div>
            ...
            <?php $form=$this->beginWidget('CActiveForm', array(
                ...
                <div class="element">
                        ...
                        <br/><br/>
                        <label for="amount"><span style="color: red;">*</span>Redemption Point:</label>
